...
const EditProfile = ({
  ...
  return (
    <div className="container mt-5 mb-5">
      <section className="heading--secondary-gradient text-center">
      <h1 className="heading-size--l heading--secondary-gradient text-center mb-5">Edit Your Profile</h1>
        <hr />
        <form className="form form-default" onSubmit={e => onSubmit(e)}>
          <div className="row form-group">
            <label htmlFor="location" className="form-editprofile--label">
              Title*:
            </label>
            <input
              type="text"
            ...
            <label htmlFor="skills" className="form-editprofile--label">
              Skills (please seperate with commas)*:
            </label>
            <input
              type="text"
              name="skills"
            ...
            <label htmlFor="bio" className="form-editprofile--label">
              Bio:
            </label>
            <textarea
              type="text"
          ...
          <div className="row">
            <h2 className="mb-4 ml-5">Social Media</h2>
          </div>

          <div className="row">
            <div className="col-sm-2">
              <label htmlFor="twitter" className="form-editprofile--label mr-2">
                Twitter:
              </label>
            </div>
          ...
          <div className="row">
            <div className="col-sm-2">
              <label
                htmlFor="instagram"
                className="form-editprofile--label mr-2"
              >
                Instagram:
              </label>
            </div>
          ...
          <div className="row">
            <div className="col-sm-2">
              <label htmlFor="github" className="form-editprofile--label mr-2">
                Github:
              </label>
            </div>
            <div className="col-sm-10">
